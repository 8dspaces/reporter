var ajax_comments = {
  ...
  onsubmit: function() {
    ...
    jQuery.ajax({
      type: 'POST',
      url: 'http://www.advancedqtp.com/wp-content/plugins/ajax-comments/ajax-comments-post.php',
      ...
      beforeSend: function(XMLHttpRequest) {
        ...
        jQuery('input[@type=submit]', form) // select form submit button
          ...
          .hide() // hide it
          .after('<div class="ajax_comments_spinner" title="Submitting your comment..." style="background:url(http://www.advancedqtp.com/wp-content/plugins/ajax-comments/ajax-comments-spinner.gif);width:220px;height:19px;text-indent:-9999px;font-size:0;line-height:0;">Submitting...</div>'); // show AJAX spinner
      },
