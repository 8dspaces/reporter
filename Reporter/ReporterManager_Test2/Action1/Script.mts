...
Call oReporterManager.StartEngine("Text", "Backup", "File>C:\Logs\QTPLog.txt|ClearExisting>False")
...
'Set up a user popup that alerts whoever's watching that an error has occured  - enable major time saves as a script can be stopped imidiatly
 ...
 'Test the logs :
Call oReporterManager.Report ("Pass", "Step 10" ,"Window Should Open" ,"All OK", "No Details")
Call oReporterManager.Report ("Warning", "Step 20" ,"Window Should Open" ,"It Didn't", "Some Details")
Call oReporterManager.Report ("Fail", "Step 30" ,"Window Should Open" ,"App. Crashed", "Bla Bla Bla")
